...
import { Plus, Workflow, FolderKanban, Filter } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div>
            <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent">
              Workflows
            </h1>
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="text-base font-medium text-gray-400">Loading workflows...</p>
          </div>
        ) : workflows.length === 0 ? (
          <motion.div
          ...
          >
            <Card className="text-center py-12 border-dashed glass-card">
              <CardHeader>
                ...
                <CardTitle className="text-2xl mb-2 text-white">No workflows yet</CardTitle>
          ...
          <>
            ...
            {projects.length > 0 && (
              <div className="mb-6 flex items-center gap-3 flex-wrap">
                ...
                <span className="text-sm font-medium text-gray-400">Filter by project:</span>
                <Button
