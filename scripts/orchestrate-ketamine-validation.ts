/**
 * Orchestrate Validation Step 3: Narrative + Personas for Ketamine Project
 * 
...
async function orchestrateKetamineValidation() {
  ...
  if (!existsSync(manusPath)) {
    ...
    console.error("   Please ensure the Manus discovery pack has been imported.");
    process.exit(1);
  }
...
For example, instead of "Source: [1]", use "Source: [1] The Guardian. 'Extreme biohacking...' - https://www.theguardian.com/..."
...
2. **Extract Persona** (for validation targeting):
   ...
   - Focus on the "Optimized CTO" persona from the discovery pack
...
- ✅ GOOD: "Source: [1] The Guardian. 'Extreme biohacking: the tech guru who spent $250,000 trying to live for ever.' - https://www.theguardian.com/science/2018/sep/21/extreme-biohacking-tech-guru-who-spent-250000-trying-to-live-for-ever-serge-faguet"
...
orchestrateKetamineValidation().catch((error) => {
